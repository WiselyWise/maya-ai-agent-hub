      ...
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="backdrop-blur-[1px]">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl" dangerouslySetInnerHTML={{
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button asChild size="lg" className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white shadow-lg hover:shadow-glow transition-all duration-300 rounded-xl px-8">
                <a href={ctaLink}>
