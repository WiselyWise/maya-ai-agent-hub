      ...
      <div className="container mx-auto text-center">
        ...
        <AnimateOnScroll animation="fade-in" delay={200}>
          <p className="text-xl text-white mb-4 max-w-3xl mx-auto leading-relaxed">
            Quick contract risk identification for busy business owners and executives. 
          ...
          <div className="bg-orange-500/20 border border-orange-500/30 rounded-lg p-4 mb-8 max-w-4xl mx-auto">
            <p className="text-orange-100 text-sm">
              ...
              Always consult with qualified professional advisors for your specific situation and compliance requirements.
            </p>
          </div>
        </AnimateOnScroll>
