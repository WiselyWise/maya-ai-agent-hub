...
const relatedTools = [
  {
    ...
    description: "Create professional presentations with AI assistance to communicate your ideas effectively.",
...
const DocumentGenieRelatedTools = () => {
  return (
    <section className="py-16 container mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-white/70 max-w-2xl mx-auto">
          Discover other AI-powered tools that complement Document Genie and enhance your business operations.
        </p>
      </div>
...
export default DocumentGenieRelatedTools;
